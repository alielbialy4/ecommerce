    ...
    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12 m-auto">
        <div class="card  box-shadow-0">
            <div class="card-header">
                <h2 class="card-title mb-1"> إضافة صنف</h2>
                <p class="mb-2">
					من هنا يمكنك إضافة صنف...
				</p>
            </div>
            <div class="card-body pt-0">
                <form class="form-horizontal" action="{{ route('section.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" name="name" value="{{ old('name') }}" autofocus class="form-control" id="inputName" placeholder="إضف اسم الصنف">
                    </div>
