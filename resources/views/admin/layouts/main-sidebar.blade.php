...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ route('dashboard.admin') }}">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('section.index') }}">
                    ...
                    <span class="side-menu__label mr-3">الاصناف</span>
                </a>
            </li>

            <li class="slide">
                <a class="side-menu__item" href="{{ route('product.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('users.admin.index') }}">
